...
class StudyServiceImplTest {
    ...
    @Test
    void start_whenTopicExists_createsStudySession() {
        ...
        var response = studyService.start(StartStudyRequest.builder().topic("Spring Security").build());
    ...
    @Test
    void start_whenTopicAndAudioMissing_throwsBadRequest() {
        assertThrows(BadRequestException.class,
                () -> studyService.start(StartStudyRequest.builder().build()));
    }

    @Test
    void generateQuestions_returnsSixQuestionsWithDifficultyAndType() {
        ...
        session.setTopic("Java Concurrency");
        ...
        var response = studyService.generateQuestions(
                GenerateStudyQuestionsRequest.builder().studySessionId(sessionId).build()
        );
